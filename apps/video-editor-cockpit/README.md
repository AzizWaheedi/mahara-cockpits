...
with Bun 1.4 (the lockfile is version 2; Vercel's default bun is 1.3 and
rejects it) and publishes `dist/`. From a machine, the same site still ships from this folder:
